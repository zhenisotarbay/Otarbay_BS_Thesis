...
syms T01 T12 T23 T34 T45 T56 T03;
...
T45=subs(T45,{alf4,a4,d5,t5},{0,L4,0,0})
...
% Frame Three {3}
  ...
  text(double(T03(1,1)/3),double(T03(2,1)/3),double(T03(3,1)/3),'X_{3}','Color','blue','FontSize',20);
  text(double(T03(1,2)/3),double(T03(2,2)/3),double(T03(3,2)/3),'Y_{3}','Color','blue','FontSize',20);
  text(double(T03(1,3)/3),double(T03(2,3)/3),double(T03(3,3)/3),'Z_{3}','Color','blue','FontSize',20);
  
  %Frame 4
  quiver3(double(T04(1,4)/3),0,0,double(T04(3,1)/3)),
