...
T01=subs(T01,{alf0,a0,d1,t1},{0,0,0,0});
T12=subs(T12,{alf1,a1,d2,t2},{-pi/2,0,0,0+pi/2})
T23=subs(T23,{alf2,a2,d3,t3},{pi/2,0,0,0}),{alf0,a0,d1,t1},{0,0,0,0});
%T12=subs(T12,{alf1,a1,d2,t2},{-pi/2,0,0,0})   % Why this???
...
% Frame Three {3}
  ...
  quiver3(0,0,0,double(T03(1,1)/3),double(T03(2,1)/3),double(T03(3,1)/3),'y','LineWidth',2)
  quiver3(0,0,0,double(T03(1,2)/3),double(T03(2,2)/3),double(T03(3,2)/3),'y','LineWidth',2)
  quiver3(0,0,0,double(T03(1,3)/3),double(T03(2,3)/3),double(T03(3,3)/3),'y','LineWidth',2)
